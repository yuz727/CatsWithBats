...
pub fn move_player(input: Res<Input<KeyCode>>, mut player: Query<(&mut Transform, &mut PlayerVelocity), With<Player>>, time: Res<Time>){
...
pub fn move_bat(input: Res<Input<KeyCode>>,mut bat: Query<(&mut Transform, &mut PlayerVelocity), With<Bat>>, time: Res<Time>){
